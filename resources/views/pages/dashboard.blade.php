...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Obat</p>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Penjualan Har ini</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $total_penjualan }}
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Obat Kosong</p>
                                        @foreach ($status_obat as $item)
                                            <p class="mb-0">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Obat Kadaluarsa</p>
                                        @foreach ($obat_kadaluarsa as $item)
                                            <p class="mb-0">
                                                <a href="{{ route('obat.edit', [$item->kode]) }}">
                                                    {{ $item->nama_obat }}
                                                </a>
    ...
    <script>
        ...
        new Chart(ctx1, {
            type: "line",
            data: {
                labels: @php echo json_encode(array_keys($penjualan)) @endphp,
                datasets: [{
                    label: "Penjualan",
                    tension: 0.4,
                    borderWidth: 0,
                    ...
                    borderWidth: 3,
                    fill: true,
                    data: @php echo json_encode(array_values($penjualan)) @endphp,
                    maxBarThickness: 6
